...
var __jade = [{ lineno: 1, filename: "public/index.jade" }];
try {
var buf = [];
with (locals || {}) {
var interp;
...
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 5, filename: __jade[0].filename });
buf.push('Engineer App');
__jade.shift();
__jade.shift();
buf.push('</title>');
__jade.shift();
__jade.unshift({ lineno: 7, filename: __jade[0].filename });
buf.push('<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">');
__jade.shift();
...
buf.push('<meta name="apple-mobile-web-app-status-bar-style" content="none">');
__jade.shift();
...
buf.push('<link rel="apple-touch-icon-precomposed" sizes="144x144" href="img/apple-touch-icon-144-precomposed.png">');
__jade.shift();
__jade.unshift({ lineno: 14, filename: __jade[0].filename });
buf.push('<link rel="apple-touch-icon-precomposed" sizes="114x114" href="img/apple-touch-icon-114-precomposed.png">');
__jade.shift();
__jade.unshift({ lineno: 15, filename: __jade[0].filename });
buf.push('<link rel="apple-touch-icon-precomposed" sizes="72x72" href="img/apple-touch-icon-72-precomposed.png">');
__jade.shift();
__jade.unshift({ lineno: 16, filename: __jade[0].filename });
buf.push('<link rel="apple-touch-icon-precomposed" href="img/apple-touch-icon-57-precomposed.png">');
__jade.shift();
__jade.unshift({ lineno: 17, filename: __jade[0].filename });
buf.push('<link rel="apple-touch-startup-image" sizes="320x460" href="img/startup-320x460.png">');
__jade.shift();
__jade.unshift({ lineno: 18, filename: __jade[0].filename });
buf.push('<link rel="apple-touch-startup-image" sizes="640x920" href="img/startup-640x920.png">');
__jade.shift();
__jade.unshift({ lineno: 19, filename: __jade[0].filename });
__jade.shift();
__jade.unshift({ lineno: 20, filename: __jade[0].filename });
buf.push('<script src="js/libs/require/require.js" data-main="js/app">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</script>');
__jade.shift();
...
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 21, filename: __jade[0].filename });
buf.push('<div class="loading_container">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</div>');
__jade.shift();
...
buf.push('<nav id="navbar" class="navbar">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</nav>');
__jade.shift();
__jade.unshift({ lineno: 24, filename: __jade[0].filename });
buf.push('<div id="main" class="main">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</div>');
__jade.shift();
